...
[![Docs](https://img.shields.io/badge/Docs-docs.rp.one-4BA3FF?style=for-the-badge)](https://docs.rp.one)

<br />

[![Discord](https://img.shields.io/badge/Discord-Join%20Community-5865F2?style=flat-square&logo=discord&logoColor=white)](https://discord.gg/r6dmYuh99N)
[![X](https://img.shields.io/badge/X-@RP__ONE__CHAIN-000000?style=flat-square&logo=x&logoColor=white)](https://x.com/RP_ONE_CHAIN)
[![Updates](https://img.shields.io/badge/Updates-updates.rp.one-444444?style=flat-square)](https://updates.rp.one)
...
| 100,000+ TPS | 300ms Finality | < $0.00001 Fees | EVM Compatible |
|:---:|:---:|:---:|:---:|
| Custom consensus + parallel execution | Deterministic, not probabilistic | Sustained at full throughput | Full Ethereum JSON-RPC |

</div>

---

## What you can build on RP1
...
The RP1 testnet is live and open to the public.

```
RPC       https://testnet.rpc.rp.one
REST      https://testnet.rest.rp.one
EVM RPC   https://testnet.evm.rp.one

Chain ID  chain-ncPph8
Token     urp1  (1 RP1 = 1,000,000 urp1)
Prefix    rp1
```
...
| [discord.gg/r6dmYuh99N](https://discord.gg/r6dmYuh99N) | Community Discord |
| [@RP_ONE_CHAIN](https://x.com/RP_ONE_CHAIN) | X |
